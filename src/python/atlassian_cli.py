...
Usage:
  python3 scripts/atlassian_cli.py jira get ITDT-940
  python3 scripts/atlassian_cli.py jira comment ITDT-940 "Implementation complete. See PR #2."
  python3 scripts/atlassian_cli.py jira transitions ITDT-940
  python3 scripts/atlassian_cli.py jira transition ITDT-940 31
  python3 scripts/atlassian_cli.py jira search "project = ITDT AND status = 'To Do' ORDER BY created DESC"

  python3 scripts/atlassian_cli.py confluence get 203325745
  python3 scripts/atlassian_cli.py confluence find "Page Title"
  python3 scripts/atlassian_cli.py confluence create "Page Title" body.html [--parent 203325745]
  python3 scripts/atlassian_cli.py confluence create "Page Title" - [--parent 203325745]   # reads stdin
"""
...
# Add scripts/ to path so atlassian_client can be imported
